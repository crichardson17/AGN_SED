...
NotebookDataLength[     93302,       1882]
NotebookOptionsPosition[     66270,       1303]
NotebookOutlinePosition[     92558,       1864]
CellTagsIndexPosition[     92447,       1858]
WindowTitle->Classical Motion and Phase Space for a Harmonic Oscillator
WindowFrame->Normal*)
...
Cell["Classical Motion and Phase Space for a Harmonic Oscillator", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`P0$$ = -2, $CellContext`t$$ = 
    0, $CellContext`X0$$ = 2, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`X0$$], 2, 
       Row[{
        "initial conditions \!\(\*SubscriptBox[OverscriptBox[\(x\), \(~\)], \
\(0\)]\)"}]}, -2, 2}, {{
       Hold[$CellContext`P0$$], -2, 
       "\!\(\*SubscriptBox[OverscriptBox[\(p\), \(~\)], \(0\)]\)"}, -2, 2}, {{
       Hold[$CellContext`t$$], 0, "time"}, 0, 20}}, Typeset`size$$ = {
    588., {200., 205.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`X0$3160$$ = 
    0, $CellContext`P0$3161$$ = 0, $CellContext`t$3162$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`P0$$ = -2, $CellContext`t$$ = 
        0, $CellContext`X0$$ = 2}, "ControllerVariables" :> {
        Hold[$CellContext`X0$$, $CellContext`X0$3160$$, 0], 
        Hold[$CellContext`P0$$, $CellContext`P0$3161$$, 0], 
        Hold[$CellContext`t$$, $CellContext`t$3162$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> ($CellContext`movpt1 = Graphics[{
           PointSize[0.05], 
           RGBColor[0.49, 0, 0], 
           
           Point[{$CellContext`X0$$ 
              Cos[$CellContext`\[Omega] $CellContext`t$$] + $CellContext`P0$$ 
              Sin[$CellContext`\[Omega] $CellContext`t$$], 
             0.5 ($CellContext`X0$$ 
                Cos[$CellContext`\[Omega] $CellContext`t$$] + \
$CellContext`P0$$ 
                Sin[$CellContext`\[Omega] $CellContext`t$$])^2}]}]; \
$CellContext`movpt2 = Graphics[{
           PointSize[0.06], 
           RGBColor[0.49, 0, 0], 
           ...
           Point[{$CellContext`X0$$ 
              ...
              Sin[$CellContext`\[Omega] $CellContext`t$$], \
(-$CellContext`X0$$) 
              Sin[$CellContext`\[Omega] $CellContext`t$$] + $CellContext`P0$$ 
              Cos[$CellContext`\[Omega] $CellContext`t$$]}]}]; Grid[{{
           Show[$CellContext`p1, 
            Plot[
             $CellContext`H[$CellContext`X0$$, $CellContext`P0$$], \
{$CellContext`y, -5, 5}, PlotStyle -> {
               RGBColor[0.25, 0.43, 0.82], 
               Thickness[0.008], Dashed}, PerformanceGoal -> "Speed"], 
            $CellContext`p2[$CellContext`X0$$, $CellContext`P0$$], \
$CellContext`movpt1, Axes -> True, AxesLabel -> {
              Style["\!\(\*OverscriptBox[\(x\), \(~\)]\)", 18], 
              Style[
               $CellContext`V[
                OverTilde[$CellContext`x]], 18]}, 
            PlotRange -> {{-5, 5}, {-0.2, 5}}, 
            Ticks -> {{-4, -2, 0, 2, 4}, {2, 4}}, TicksStyle -> 
            Directive[20, Gray], ImageSize -> {290, 200}], 
           Show[
            $CellContext`p3[$CellContext`X0$$, $CellContext`P0$$], \
$CellContext`movpt2, 
            
            ParametricPlot[{$CellContext`X0$$ 
               Cos[$CellContext`\[Omega] $CellContext`T] + $CellContext`P0$$ 
               Sin[$CellContext`\[Omega] $CellContext`T], (-$CellContext`X0$$)
                 Sin[$CellContext`\[Omega] $CellContext`T] + \
$CellContext`P0$$ Cos[$CellContext`\[Omega] $CellContext`T]}, {$CellContext`T,
               0.001, $CellContext`t$$}, PlotStyle -> {
               Thickness[0.017], 
               RGBColor[0.49, 0, 0]}], Axes -> True, 
            PlotRange -> {{-3.1, 3.1}, {-3, 3}}, 
            Ticks -> {{-2, 0, 2}, {-2, 2}}, TicksStyle -> Directive[20, Gray],
             AxesLabel -> {
              Style["\!\(\*OverscriptBox[\(x\), \(~\)]\)", 18], 
              Style["\!\(\*OverscriptBox[\(p\), \(~\)]\)", 18]}, 
            ImageSize -> {290, 200}]}, {
           ...
           Plot[{$CellContext`X0$$ 
              ...
              Sin[$CellContext`\[Omega] $CellContext`T], (-$CellContext`X0$$) 
              Sin[$CellContext`\[Omega] $CellContext`T] + $CellContext`P0$$ 
              Cos[$CellContext`\[Omega] $CellContext`T]}, {$CellContext`T, 
             0.0001, $CellContext`t$$}, PlotRange -> {{0, 20}, {-3, 3}}, 
            Ticks -> {{0, 5, 10, 15}, {-2, 0, 2}}, TicksStyle -> 
            Directive[20, Gray], PlotStyle -> {{
               Thickness[0.012], Black}, {
               Thickness[0.012], Orange}}, AxesLabel -> {
              Style["t", Italic, 18], 
              Row[{
                Style["\!\(\*OverscriptBox[\(x\), \(~\)]\)", 18], 
                Style[" , ", 18], 
                Style["\!\(\*OverscriptBox[\(p\), \(~\)]\)", 18, Orange]}]}, 
            PerformanceGoal -> "Speed", ImageSize -> {290, 200}], 
           SpanFromLeft}}]), "Specifications" :> {{{$CellContext`X0$$, 2, 
          
          Row[{"initial conditions \!\(\*SubscriptBox[OverscriptBox[\(x\), \
\(~\)], \(0\)]\)"}]}, -2, 2, Appearance -> 
         "Labeled"}, {{$CellContext`P0$$, -2, 
          "\!\(\*SubscriptBox[OverscriptBox[\(p\), \(~\)], \(0\)]\)"}, -2, 2, 
         Appearance -> "Labeled"}, {{$CellContext`t$$, 0, "time"}, 0, 20, 
         Appearance -> "Labeled"}}, 
      "Options" :> {SynchronousUpdating -> False, TrackedSymbols -> True}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{633., {271., 276.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`movpt1 = Graphics[{
           PointSize[0.05], 
           RGBColor[0.49, 0, 0], 
           Point[{2, 2.}]}], $CellContext`\[Omega] = 1., $CellContext`movpt2 = 
        Graphics[{
           PointSize[0.06], 
           RGBColor[0.49, 0, 0], 
           Point[{2, -2}]}], $CellContext`p1 = Graphics[{{{}, {}, {
             Hue[0.67, 0.6, 0.6], 
             RGBColor[0.49, 0, 0], 
             Thickness[0.013], 
             Line[CompressedData["
1:
              "]]}}}, {
          AspectRatio -> GoldenRatio^(-1), Axes -> True, AxesOrigin -> {0, 0},
            PlotRange -> {{-5, 5}, {0., 12.499998979591858`}}, 
           PlotRangeClipping -> True, PlotRangePadding -> {
             Scaled[0.02], 
             Scaled[0.02]}}], 
        Attributes[PlotRange] = {ReadProtected}, $CellContext`H[
          Pattern[$CellContext`X0, 
           Blank[]], 
          Pattern[$CellContext`P0, 
           Blank[]]] := 
        0.5 $CellContext`X0^2 + 0.5 $CellContext`P0^2, $CellContext`p2[
          Pattern[$CellContext`X0, 
           Blank[]], 
          Pattern[$CellContext`P0, 
           Blank[]]] := Graphics[{
           Text[
            Style["\[Times]", 20, 
             Darker[
              RGBColor[0.6, 0.73, 0.36]], Bold], {0, 0}], 
           RGBColor[0.25, 0.43, 0.82], 
           Text[
            Style["\[Times]", 20, 
             RGBColor[0.25, 0.43, 0.82], Bold], {-
             Sqrt[2 (0.5 $CellContext`X0^2 + 0.5 $CellContext`P0^2)], 
             0.5 $CellContext`X0^2 + 0.5 $CellContext`P0^2}], 
           RGBColor[0.25, 0.43, 0.82], 
           Text[
            Style["\[Times]", 20, 
             RGBColor[0.25, 0.43, 0.82], Bold], {
             Sqrt[2 (0.5 $CellContext`X0^2 + 0.5 $CellContext`P0^2)], 
             0.5 $CellContext`X0^2 + 
             0.5 $CellContext`P0^2}]}], $CellContext`p3[
          Pattern[$CellContext`X0, 
           Blank[]], 
          Pattern[$CellContext`P0, 
           Blank[]]] := Graphics[{
           Text[
            Style["\[Times]", 20, 
             Darker[
              RGBColor[0.6, 0.73, 0.36]], Bold], {0, 
             Sqrt[$CellContext`P0^2 + $CellContext`X0^2]}], 
           Text[
            Style["\[Times]", 20, 
             Darker[
              RGBColor[0.6, 0.73, 0.36]], Bold], {
            0, -Sqrt[$CellContext`P0^2 + $CellContext`X0^2]}], 
           Text[
            Style["\[Times]", 20, 
             RGBColor[0.25, 0.43, 0.82], Bold], {
             Sqrt[$CellContext`P0^2 + $CellContext`X0^2], 0}], 
           Text[
            Style["\[Times]", 20, 
             RGBColor[0.25, 0.43, 0.82], Bold], {-
             Sqrt[$CellContext`P0^2 + $CellContext`X0^2], 0}]}]}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{{
          HoldComplete[$CellContext`\[Omega] = 1.; Null], 
          HoldComplete[Null], 
          
          HoldComplete[$CellContext`p1 = 
            Plot[0.5 $CellContext`y^2, {$CellContext`y, -5, 5}, PlotStyle -> {
                RGBColor[0.49, 0, 0], 
                Thickness[0.013]}, Axes -> True]; Null]}, $CellContext`H[
            Pattern[$CellContext`X0, 
             Blank[]], 
            Pattern[$CellContext`P0, 
             Blank[]]] := 0.5 $CellContext`X0^2 + 0.5 $CellContext`P0^2; 
         Null, $CellContext`p2[
            Pattern[$CellContext`X0, 
             Blank[]], 
            Pattern[$CellContext`P0, 
         ...
         Null, $CellContext`p3[
            ...
            Pattern[$CellContext`P0, 
             ...
             Text[
              Style["\[Times]", 20, 
               RGBColor[0.25, 0.43, 0.82], Bold], {-
               Sqrt[$CellContext`P0^2 + $CellContext`X0^2], 0}]}]; Null}]]; 
...
Cell[TextData[{
 "This Demonstration illustrates the classical harmonic motion of a particle \
governed by the Hamiltonian ",
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    OverscriptBox["x", "~"], "\[Congruent]", 
    RowBox[{
     SqrtBox[
      RowBox[{"m", " ", "\[Omega]"}]], "x"}]}], TraditionalForm]], 
  "InlineMath"],
 ", ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    OverscriptBox["p", "~"], "\[Congruent]", 
    FractionBox["p", 
     SqrtBox[
      RowBox[{"m", " ", "\[Omega]"}]]]}], TraditionalForm]], "InlineMath"],
 ". Here ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    OverscriptBox["x", "~"], "(", "t", ")"}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    OverscriptBox["p", "~"], "(", "t", ")"}], TraditionalForm]], "InlineMath"],
 " are obtained by solving Hamilton's equations of motion, subject to the \
initial conditions ",
 Cell[BoxData[
  FormBox[
   RowBox[{
 ...
 Cell[BoxData[
  ...
  "InlineMath"],
 ". The three panels animate synchronously: (1) the motion of the particle in \
the potential; (2) the phase space trajectory; and (3) the time series of ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    OverscriptBox["x", "~"], "(", "t", ")"}], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    OverscriptBox["p", "~"], "(", "t", ")"}], TraditionalForm]], "InlineMath"],
 ". In the upper two panels, the points with minimum (turning points) and \
maximum momentum are labeled with blue and green ",
 Cell[BoxData[
...
Cell[TextData[{
 ButtonBox["Phase Space Trajectory",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/PhaseSpaceTrajectory.html"], 
    None},
  ButtonNote->
   "http://scienceworld.wolfram.com/physics/PhaseSpaceTrajectory.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Simple Harmonic Oscillator",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/SimpleHarmonicOscillator.\
html"], None},
  ButtonNote->
   "http://scienceworld.wolfram.com/physics/SimpleHarmonicOscillator.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ClassicalMotionAndPhaseSpaceForAHarmonicOscillator&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
ClassicalMotionAndPhaseSpaceForAHarmonicOscillator/\
ClassicalMotionAndPhaseSpaceForAHarmonicOscillator-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Classical Motion and Phase Space for a Harmonic Oscillator",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
ClassicalMotionAndPhaseSpaceForAHarmonicOscillator/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
ClassicalMotionAndPhaseSpaceForAHarmonicOscillator/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[54324, 1014, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[54585, 1023, 3221, 69, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[65448, 1278, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 92158, 1847},
 {"Copyright", 92355, 1852}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[622, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34953, 590, 79, 0, 70, "DemoTitle"],
Cell[35035, 592, 16992, 341, 70, "Output",
 CellID->7022770],
Cell[52030, 935, 2291, 77, 70, "ManipulateCaption"],
Cell[54324, 1014, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[54585, 1023, 3221, 69, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[57809, 1094, 44, 0, 70, "RelatedLinksSection"],
Cell[57856, 1096, 528, 17, 70, "RelatedLinks",
 CellID->239801996],
Cell[58387, 1115, 535, 17, 70, "RelatedLinks",
 CellID->6250178],
Cell[58925, 1134, 4893, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[63821, 1227, 45, 0, 70, "CitationSection"],
Cell[63869, 1229, 989, 27, 70, "Citations"],
Cell[64861, 1258, 584, 18, 70, "Author"],
Cell[65448, 1278, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature eRUeF8zV@O2Mkv7SyBqCweh1 *)

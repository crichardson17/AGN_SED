...
ax3.scatter(np.log10(np.divide(np.add(np.add(SDSS_Data[5],SDSS_Data[6]),SDSS_Data[17]),SDSS_Data[11])),np.log10(np.divide(np.add(SDSS_Data[5],SDSS_Data[6]),SDSS_Data[16])), edgecolor = '', c = '#000080',s=5.0)
...
ax3.set_xlim(np.log10(10**(0)),np.log10(10**2))
ax3.set_ylim(np.log10(10**(0)), np.log10(10**(2)))
ax3.set_ylabel(r'Log$_{10}$([N II] $\lambda 6584$ / H$\alpha$')
ax3.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ + [O III] $\lambda 5007$/ H$\beta$)')

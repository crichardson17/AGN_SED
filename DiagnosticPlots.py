...
directory=r'Users/chris_000/Documents/GitHub/AGN_SED/Cloudy_Data' 
...
for root, dirs, files in os.walk(normSource, topdown=False):
    for name in files:
        if  name.endswith('.lin'):
            ...
            dfs.append(pd.read_csv(os.path.join(root, name), delimiter='/t', index_cols=False, usecols=['TOTL  4861A','O  3  5007A', 'O  1  6300A', 'H  1  6563A','N  2  6584A','S  2  6720A' ]))

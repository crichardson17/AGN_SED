...
ax1.scatter(d['Ne V / Ne III'].get_value(1),d['Ne V / Ne II'].get_value(1), marker = "s",c='#7056C5', s = 30, label = "10^4 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(4),d['Ne V / Ne II'].get_value(4), marker = "s",c='#3914AF', s = 30, label = "10^5 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(7),d['Ne V / Ne II'].get_value(7), marker = "s",c='#2B0E87', s = 30, label = "10^6 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(10),d['Ne V / Ne II'].get_value(10), marker = "s",c='#200969', s = 30, label = "10^7 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(2),d['Ne V / Ne II'].get_value(2), marker = "s",c='#50DA50', s = 30, label = "10^4 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(5),d['Ne V / Ne II'].get_value(5), marker = "s",c='#00CC00', s = 30, label = "10^5 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(8),d['Ne V / Ne II'].get_value(8), marker = "s",c='#009D00', s = 30, label = "10^6 Fit")
ax1.scatter(d['Ne V / Ne III'].get_value(11),d['Ne V / Ne II'].get_value(11), marker = "s",c='#007A00', s = 30, label = "10^7 Fit")
...
ax2.plot(lin21Ne5Ne3,lin21Ne52431, c = '0')
...
ax3.plot(lin21Ne5Ne2,lin21Ne52431, c = '0')

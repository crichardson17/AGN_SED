...
ax1.plot(oxygenT4_data[:,0],oxygenT4_data[:,1], c = 'g', ls = '--', label = 'O I')
...
ax2.plot(oxygenT5_data[:,0],oxygenT5_data[:,1], c = 'g', ls = '--', label = 'O I')
...
ax3.plot(oxygenT6_data[:,0],oxygenT6_data[:,1], c = 'g', ls = '--', label = 'O I')
...
ax4.plot(oxygenT7_data[:,0],oxygenT7_data[:,1], c = 'g', ls = '--', label = 'O I')
...
ax5.plot(oxygenT4_ax117_data[:,0],oxygenT4_ax117_data[:,1], c = 'g', ls = '--', label = 'O I')
ax5.plot(oxygenT4_ax117_data[:,0], oxygenT4_ax117_data[:,2],c = 'r', ls = '--', label = 'O II')
ax5.plot(oxygenT4_ax117_data[:,0], oxygenT4_ax117_data[:,3],c = 'b', ls = '--', label = 'O III')
...
ax6.plot(oxygenT5_ax117_data[:,0],oxygenT5_ax117_data[:,1], c = 'g', ls = '--', label = 'O I')
ax6.plot(oxygenT5_ax117_data[:,0], oxygenT5_ax117_data[:,2],c = 'r', ls = '--', label = 'O II')
ax6.plot(oxygenT5_ax117_data[:,0], oxygenT5_ax117_data[:,3],c = 'b', ls = '--', label = 'O III')
ax6.set_yticklabels([])
...
ax7.plot(oxygenT6_ax117_data[:,0],oxygenT6_ax117_data[:,1], c = 'g', ls = '--', label = 'O I')
ax7.plot(oxygenT6_ax117_data[:,0], oxygenT6_ax117_data[:,2],c = 'r', ls = '--', label = 'O II')
ax7.plot(oxygenT6_ax117_data[:,0], oxygenT6_ax117_data[:,3],c = 'b', ls = '--', label = 'O III')
ax7.set_yticklabels([])
...
ax8.plot(oxygenT7_ax117_data[:,0],oxygenT7_ax117_data[:,1], c = 'g', ls = '--', label = 'O I')
ax8.plot(oxygenT7_ax117_data[:,0], oxygenT7_ax117_data[:,2],c = 'r', ls = '--', label = 'O II')
ax8.plot(oxygenT7_ax117_data[:,0], oxygenT7_ax117_data[:,3],c = 'b', ls = '--', label = 'O III')
ax8.set_yticklabels([])
...
plt.suptitle('Ionization Structure for Sulfur and Oxygen')
ax1.legend()
plt.show()

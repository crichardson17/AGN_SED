...
ax1.scatter(d['O III 4363 / O III 5007'].get_value(0),d['S II 6716/ S II 6731'].get_value(0), marker = "s",c='#FF5D5D', s = 35, label = "10^4")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(3),d['S II 6716/ S II 6731'].get_value(3), marker = "s",c='#FF0000', s = 35, label = "10^5")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(6),d['S II 6716/ S II 6731'].get_value(6), marker = "s",c='#C60000', s = 35, label = "10^6")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(9),d['S II 6716/ S II 6731'].get_value(9), marker = "s",c='#9B0000', s = 35, label = "10^7")

ax1.scatter(d['O III 4363 / O III 5007'].get_value(1),d['S II 6716/ S II 6731'].get_value(1), marker = "s",c='#7056C5', s = 35, label = "10^4 ax=1.17")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(4),d['S II 6716/ S II 6731'].get_value(4), marker = "s",c='#3914AF', s = 35, label = "10^5 ax=1.17")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(7),d['S II 6716/ S II 6731'].get_value(7), marker = "s",c='#2B0E87', s = 35, label = "10^6 ax=1.17")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(10),d['S II 6716/ S II 6731'].get_value(10), marker = "s",c='#200969', s = 35, label = "10^7 ax=1.17")

ax1.scatter(d['O III 4363 / O III 5007'].get_value(2),d['S II 6716/ S II 6731'].get_value(2), marker = "s",c='#50DA50', s = 35, label = "10^4 ax=2.19")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(5),d['S II 6716/ S II 6731'].get_value(5), marker = "s",c='#00CC00', s = 35, label = "10^5 ax=2.19")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(8),d['S II 6716/ S II 6731'].get_value(8), marker = "s",c='#009D00', s = 35, label = "10^6 ax=2.19")
ax1.scatter(d['O III 4363 / O III 5007'].get_value(11),d['S II 6716/ S II 6731'].get_value(11), marker = "s",c='#007A00', s = 35, label = "10^7 ax=2.19")

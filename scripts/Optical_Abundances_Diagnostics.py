...
ax2.scatter(d['O II / N II'].get_value(1),d['S II 6716/ S II 6731'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4 Fit")
ax2.scatter(d['O II / N II'].get_value(4),d['S II 6716/ S II 6731'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5 Fit")
ax2.scatter(d['O II / N II'].get_value(7),d['S II 6716/ S II 6731'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6 Fit ")
ax2.scatter(d['O II / N II'].get_value(10),d['S II 6716/ S II 6731'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7 Fit")

ax2.scatter(d['O II / N II'].get_value(2),d['S II 6716/ S II 6731'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4 Fit")
ax2.scatter(d['O II / N II'].get_value(5),d['S II 6716/ S II 6731'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5 Fit")
ax2.scatter(d['O II / N II'].get_value(8),d['S II 6716/ S II 6731'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6 Fit ")
ax2.scatter(d['O II / N II'].get_value(11),d['S II 6716/ S II 6731'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7 Fit")

...
ax1.scatter(d['O III / Ar III'].get_value(1),d['Ne III / H-Alpha'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4 ax=1.2")
ax1.scatter(d['O III / Ar III'].get_value(4),d['Ne III / H-Alpha'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5 ax=1.2")
ax1.scatter(d['O III / Ar III'].get_value(7),d['Ne III / H-Alpha'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6 ax=1.2")
ax1.scatter(d['O III / Ar III'].get_value(10),d['Ne III / H-Alpha'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7 ax=1.2")
ax1.scatter(d['O III / Ar III'].get_value(2),d['Ne III / H-Alpha'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4 ax=1.6")
ax1.scatter(d['O III / Ar III'].get_value(5),d['Ne III / H-Alpha'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5 ax=1.6")
ax1.scatter(d['O III / Ar III'].get_value(8),d['Ne III / H-Alpha'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6 ax=1.6")
ax1.scatter(d['O III / Ar III'].get_value(11),d['Ne III / H-Alpha'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7 ax=1.6")

...
d['O II / N II'] = np.log10(np.divide(d['N  2  6584A'],d['TOTL  3727A']))
...
#Shirazi_File = r'C:/Users/chris/Documents/GitHub/AGN_SED/sdss_data/shirazi12.csv'
...
ax2 = plt.subplot(121, adjustable = 'box-forced',aspect = 'equal', autoscale_on = False)
#ax3 = plt.subplot(233,  adjustable = 'box-forced', autoscale_on = False)
ax4 = plt.subplot(122, adjustable = 'box-forced', aspect = 'equal', autoscale_on = False)
#ax5 = plt.subplot(235)
#ax6 = plt.subplot(236)
...
#ax1.scatter(d['O III / Ar III'].get_value(9),d['Ne III / H-Alpha'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
#
#ax1.scatter(d['O III / Ar III'].get_value(1),d['Ne III / H-Alpha'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4 ax=1.17")
#ax1.scatter(d['O III / Ar III'].get_value(4),d['Ne III / H-Alpha'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5 ax=1.17")
#ax1.scatter(d['O III / Ar III'].get_value(7),d['Ne III / H-Alpha'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6 ax=1.17")
#ax1.scatter(d['O III / Ar III'].get_value(10),d['Ne III / H-Alpha'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7 ax=1.17")
#
#ax1.scatter(d['O III / Ar III'].get_value(2),d['Ne III / H-Alpha'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4 ax=2.9")
#ax1.scatter(d['O III / Ar III'].get_value(5),d['Ne III / H-Alpha'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5 ax=2.9")
#ax1.scatter(d['O III / Ar III'].get_value(8),d['Ne III / H-Alpha'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6 ax=2.9")
#ax1.scatter(d['O III / Ar III'].get_value(11),d['Ne III / H-Alpha'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7 ax=2.9")
#ax1.plot(basexvalO3A3, baseyvalueNe3, c = '0')
#ax1.plot(linxval03A3,linyvalNe3,c = '0')
#ax1.plot(lin16xval03A3,lin16yvalNe3, c = '0')
#ax1.set_xlim(-1.5,4)
#ax1.set_ylim(-4,1)
#ax1.set_xlabel(r'Log$_{10}$([O III] $\lambda 5007$ / [Ar III] $\lambda 7135$)', fontsize = 20)
#ax1.set_ylabel(r'Log$_{10}$([Ne III] $\lambda 3869$ / H$\alpha$)', fontsize = 20)
...
ax2.scatter(np.log10(SF_Array[:,3]),np.log10(SF_Array[:,14]) , c = '#453785',edgecolor = '', s = 5,label = 'Star-Forming')
ax2.scatter(np.log10(Comp_Array[:,3]),np.log10(Comp_Array[:,14]),edgecolor = '', s = 5,label ='Composite')
ax2.scatter(np.log10(AGN_Array[:,3]),np.log10(AGN_Array[:,14]),edgecolor = '', s = 5, c = '#800000',label = 'Seyfert')
ax2.scatter(np.log10(SDSS_Data_Ratios[(Linercondition3 & Linercondition5),3]),np.log10(SDSS_Data_Ratios[(Linercondition3 & Linercondition5),14]),edgecolor = '', s = 5, c = 'g',label = 'LINER')
...
ax2.scatter(d['O II / N II'].get_value(9),d['S II 6716/ S II 6731'].get_value(6), marker = "s",c='#9B0000', s = 50, label = "10^7")

ax2.scatter(d['O II / N II'].get_value(1),d['S II 6716/ S II 6731'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4 ax=1.17")
ax2.scatter(d['O II / N II'].get_value(4),d['S II 6716/ S II 6731'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5 ax=1.17")
ax2.scatter(d['O II / N II'].get_value(7),d['S II 6716/ S II 6731'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6 ax=1.17 ")
ax2.scatter(d['O II / N II'].get_value(10),d['S II 6716/ S II 6731'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7 ax=1.17")

ax2.scatter(d['O II / N II'].get_value(2),d['S II 6716/ S II 6731'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4 ax=2.19")
ax2.scatter(d['O II / N II'].get_value(5),d['S II 6716/ S II 6731'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5 ax=2.19")
ax2.scatter(d['O II / N II'].get_value(8),d['S II 6716/ S II 6731'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6 ax=2.19 ")
ax2.scatter(d['O II / N II'].get_value(11),d['S II 6716/ S II 6731'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7 ax=2.19")
ax2.plot(basexvalO2N2,baseyvalS2,c = '0')
ax2.plot(linxvalO2N2,linyvalS2, c = '0')
ax2.plot(lin16xvalO2N2,lin16yvalS2, c = '0')
ax2.set_ylabel(r'Log$_{10}$([S II] $\lambda 6716$ / [S II] $\lambda 6731$', fontsize = 20)
ax2.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [N II] $\lambda 6584$)', fontsize = 20)
ax2.set_xlim(-1,2)
ax2.set_ylim(-1,1.5)
...
#ax3.scatter(d['O II + O III / H-Beta'].get_value(9),d['O II / N II'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(1),d['O II / N II'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(4),d['O II / N II'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(7),d['O II / N II'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(10),d['O II / N II'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(2),d['O II / N II'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(5),d['O II / N II'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(8),d['O II / N II'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
#ax3.scatter(d['O II + O III / H-Beta'].get_value(11),d['O II / N II'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
#ax3.set_ylabel(r'Log$_{10}$([N II] $\lambda 6584$ / H$\alpha$)', fontsize = 20)
...
ax4.scatter(d['O II / N II'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")

ax4.scatter(d['O II / N II'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
ax4.scatter(d['O II / N II'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
ax4.scatter(d['O II / N II'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
ax4.scatter(d['O II / N II'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")

ax4.scatter(d['O II / N II'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
ax4.scatter(d['O II / N II'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
ax4.scatter(d['O II / N II'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
ax4.scatter(d['O II / N II'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
ax4.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [N II] $\lambda 6584$)', fontsize = 20)
ax4.set_xlim(-1,2)
ax4.set_ylim(-1,1.5)
...
#ax5.scatter(d['O III / Ne III'].get_value(0),d['Ar III / H-Alpha'].get_value(0), marker = "s",c='#FF5D5D', s = 50, label = "10^4")
#ax5.scatter(d['O III / Ne III'].get_value(3),d['Ar III / H-Alpha'].get_value(3), marker = "s",c='#FF0000', s = 50, label = "10^5")
#ax5.scatter(d['O III / Ne III'].get_value(6),d['Ar III / H-Alpha'].get_value(6), marker = "s",c='#C60000', s = 50, label = "10^6")
#ax5.scatter(d['O III / Ne III'].get_value(9),d['Ar III / H-Alpha'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
#
#ax5.scatter(d['O III / Ne III'].get_value(1),d['Ar III / H-Alpha'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
#ax5.scatter(d['O III / Ne III'].get_value(4),d['Ar III / H-Alpha'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
#ax5.scatter(d['O III / Ne III'].get_value(7),d['Ar III / H-Alpha'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
#ax5.scatter(d['O III / Ne III'].get_value(10),d['Ar III / H-Alpha'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
#
#ax5.scatter(d['O III / Ne III'].get_value(2),d['Ar III / H-Alpha'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
#ax5.scatter(d['O III / Ne III'].get_value(5),d['Ar III / H-Alpha'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
#ax5.scatter(d['O III / Ne III'].get_value(8),d['Ar III / H-Alpha'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
#ax5.scatter(d['O III / Ne III'].get_value(11),d['Ar III / H-Alpha'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
#ax5.plot(basexvalO3Ne3,baseyvalAr3, c= '0')
#ax5.plot(linxvalO3Ne3, linyvalAr3, c='0')
#ax5.plot(lin16xvalO3Ne3,lin16yvalAr3, c = '0')
#ax5.set_xlabel(r'Log$_{10}$([O III] $\lambda 5007$ / [Ne III] $\lambda 3869$', fontsize = 20)
#ax5.set_ylabel(r'Log$_{10}$([Ar III] $\lambda 7135$ / H$\alpha$)', fontsize = 20)
#ax5.set_xlim(-1,3)
#ax5.set_ylim(-4,1.5)
...
#ax6.scatter(d['He I / H-Beta'].get_value(0),d['O III / H-Beta'].get_value(0), marker = "s",c='#FF5D5D', s = 50, label = "10^4")
#ax6.scatter(d['He I / H-Beta'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s",c='#FF0000', s = 50, label = "10^5")
#ax6.scatter(d['He I / H-Beta'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s",c='#C60000', s = 50, label = "10^6")
#ax6.scatter(d['He I / H-Beta'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
#
#ax6.scatter(d['He I / H-Beta'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
#ax6.scatter(d['He I / H-Beta'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
#ax6.scatter(d['He I / H-Beta'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
#ax6.scatter(d['He I / H-Beta'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
#
#ax6.scatter(d['He I / H-Beta'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
#ax6.scatter(d['He I / H-Beta'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
#ax6.scatter(d['He I / H-Beta'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
#ax6.scatter(d['He I / H-Beta'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
#ax6.plot(baseHe1,baseyvalO3, c ='0')
#ax6.plot(linHe1, lin16yvalO3, ls = '--', c = '0')
#ax6.plot(lin21He1, lin16yvalO3, ls = ':', lw = 3, c = '0')
#ax6.set_xlim(-2,1)
#ax6.set_xlabel(r'Log$_{10}$([He I] $\lambda 5876$ / H$\beta$)', fontsize = 20)
#ax6.set_ylabel(r'Log$_{10}$([O III] $\lambda 5007$ / H$\beta$)', fontsize = 20)
#

plt.text(-1.5,1.75,'AGN Metallicity Diagnostic Plots: Metallicity = 1.5, Efrac = 0.01, Phi(h) = 10.4771, n(h) = 2.5', horizontalalignment='center', fontsize = 20)
...
plt.show() 
plt.savefig(r'C:\Users\chris\Documents\GitHub\AGN_SED\Presentations\Abundances.png',dpi = 1000)
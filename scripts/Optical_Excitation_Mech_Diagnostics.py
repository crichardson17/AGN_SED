...
for root, dirs, files in os.walk(rootdirectory, topdown=False):
    for name in files:
        if name.startswith('Ionization_35_Linear_Fit_ax219_SED') and name.endswith('.lin'):
            ...
            'NE 3  3869A','AR 3  7135A','HE 1  5876A','TOTL  4363A','O  3  4959A','O II  3726A', 'O II  3729A']))
            d = pd.concat(dfs, ignore_index=True)
        elif name.startswith('Aox_124_Ionization_35') and name.endswith('.lin'):
             #print name
            #only read columns from list cols
             dfs.append(pd.read_csv(os.path.join(root, name), delimiter="\t", sep='\s*',usecols=['TOTL  4861A','O  3  5007A', 'NE 5  3426A', 'NE 3  3869A',
            'TOTL  4363A', 'O  1  6300A', 'H  1  6563A','N  2  6584A','S  2  6720A' , 'HE 2  4686A','TOTL  3727A', 'S II  6716A', 'S II  6731A',
...
l1 = ax1.scatter(d['N II / H-Alpha'].get_value(0),d['O III / H-Beta'].get_value(0), marker = "s", c = '#FF5D5D', s = 50, label = "10^4")
l2 = ax1.scatter(d['N II / H-Alpha'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s", c = '#FF0000', s = 50, label = "10^5")
l3 = ax1.scatter(d['N II / H-Alpha'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s", c = '#C60000',s = 50, label = "10^6")
l4 = ax1.scatter(d['N II / H-Alpha'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s", c = '#9B0000', s = 50, label = "10^7")
...
l9 = ax1.scatter(d['N II / H-Alpha'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4 ax=2.19")
l10 = ax1.scatter(d['N II / H-Alpha'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5 ax=2.19")
l11 = ax1.scatter(d['N II / H-Alpha'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6 ax=2.19")
l12 = ax1.scatter(d['N II / H-Alpha'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7 ax=2.19")
...
ax1.set_ylabel(r'Log$_{10}$([O III] $\lambda 5007$ / H$\beta$)', fontsize = 20)

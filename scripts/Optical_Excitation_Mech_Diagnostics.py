...
ax2.scatter(d['O I / H-Alpha'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s",c='green', s = 30, label = "10^5")
ax2.scatter(d['O I / H-Alpha'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s",c='yellow', s = 30, label = "10^6")
ax2.scatter(d['O I / H-Alpha'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax2.scatter(d['O I / H-Alpha'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax2.scatter(d['O I / H-Alpha'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax2.scatter(d['O I / H-Alpha'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax2.scatter(d['O I / H-Alpha'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax2.scatter(d['O I / H-Alpha'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax2.scatter(d['O I / H-Alpha'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax2.scatter(d['O I / H-Alpha'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax2.scatter(d['O I / H-Alpha'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
ax2.plot(x3,y3,c = '0', ls = '-', linewidth = 2)
ax2.plot(basexvalues2, baseyvalues2, c = '0')
ax2.plot(linxvalues2, linearyvalues, c = '0')
ax2.plot(lin16xvalues2,linear16yvalues, c = '0')
...
ax3.scatter(d['S II / H-Alpha'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s",c='green', s = 30, label = "10^5")
ax3.scatter(d['S II / H-Alpha'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s",c='yellow', s = 30, label = "10^6")
ax3.scatter(d['S II / H-Alpha'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax3.scatter(d['S II / H-Alpha'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax3.scatter(d['S II / H-Alpha'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax3.scatter(d['S II / H-Alpha'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax3.scatter(d['S II / H-Alpha'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax3.scatter(d['S II / H-Alpha'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax3.scatter(d['S II / H-Alpha'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax3.scatter(d['S II / H-Alpha'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax3.scatter(d['S II / H-Alpha'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
ax3.plot(x5,y5, c='0',ls = '-',linewidth=2)
ax3.plot(x6,y6, c='0',ls = '--',linewidth=3.0)
ax3.plot(basexvalues3, baseyvalues, c = '0')
ax3.plot(linxvalues3, linearyvalues, c = '0')
ax3.plot(lin16xvalues3,linear16yvalues, c = '0')
...
ax4.scatter(d['O II / H-Beta'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s",c='green', s = 30, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s",c='yellow', s = 30, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax4.scatter(d['O II / H-Beta'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax4.scatter(d['O II / H-Beta'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax4.scatter(d['O II / H-Beta'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax4.scatter(d['O II / H-Beta'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
ax4.plot(x9,y9,x10,y10,c = '0', lw = 2)
ax4.axhline(y = 0.3,xmin = -2, xmax = 0.65, c = '0', lw =3)
ax4.plot(basexvalues4,baseyvalues, c = '0')
ax4.plot(linxvalues4,linearyvalues,c = '0')
ax4.plot(lin16xvalues4,linear16yvalues, c = '0')
...
ax5.scatter(d['N II / H-Alpha'].get_value(3),d['He II / H-Beta'].get_value(3), marker = "s",c='green', s = 30, label = "10^5")
ax5.scatter(d['N II / H-Alpha'].get_value(6),d['He II / H-Beta'].get_value(6), marker = "s",c='yellow', s = 30, label = "10^6")
ax5.scatter(d['N II / H-Alpha'].get_value(9),d['He II / H-Beta'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax5.scatter(d['N II / H-Alpha'].get_value(1),d['He II / H-Beta'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax5.scatter(d['N II / H-Alpha'].get_value(4),d['He II / H-Beta'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax5.scatter(d['N II / H-Alpha'].get_value(7),d['He II / H-Beta'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax5.scatter(d['N II / H-Alpha'].get_value(10),d['He II / H-Beta'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax5.scatter(d['N II / H-Alpha'].get_value(2),d['He II / H-Beta'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax5.scatter(d['N II / H-Alpha'].get_value(5),d['He II / H-Beta'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax5.scatter(d['N II / H-Alpha'].get_value(8),d['He II / H-Beta'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax5.scatter(d['N II / H-Alpha'].get_value(11),d['He II / H-Beta'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
ax5.plot(x,y, c = '0', ls = '-', lw = 2.0)
ax5.plot(basexvalues,baseyvalues5, c ='0')
ax5.plot(linearxvalues, linyvalues5, c = '0')
ax5.plot(linear16xvalues,lin16yvalues5,c = '0')
ax5.set_xlim(-3,2)
ax5.set_ylim(-3,2)
...
ax6.scatter(d['O I / H-Alpha'].get_value(3),d['O III / O II'].get_value(3), marker = "s",c='green', s = 30, label = "10^5")
ax6.scatter(d['O I / H-Alpha'].get_value(6),d['O III / O II'].get_value(6), marker = "s",c='yellow', s = 30, label = "10^6")
ax6.scatter(d['O I / H-Alpha'].get_value(9),d['O III / O II'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax6.scatter(d['O I / H-Alpha'].get_value(1),d['O III / O II'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax6.scatter(d['O I / H-Alpha'].get_value(4),d['O III / O II'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax6.scatter(d['O I / H-Alpha'].get_value(7),d['O III / O II'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax6.scatter(d['O I / H-Alpha'].get_value(10),d['O III / O II'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax6.scatter(d['O I / H-Alpha'].get_value(2),d['O III / O II'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax6.scatter(d['O I / H-Alpha'].get_value(5),d['O III / O II'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax6.scatter(d['O I / H-Alpha'].get_value(8),d['O III / O II'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax6.scatter(d['O I / H-Alpha'].get_value(11),d['O III / O II'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
ax6.plot(x7,y7, x8,y8, c = '0', lw = 3.0)
ax6.plot(basexvalues2,baseyvalues6, c = '0')
ax6.plot(linxvalues2,linyvalues6,c =  '0')
ax6.plot(lin16xvalues2,lin16yvalues6, c = '0')

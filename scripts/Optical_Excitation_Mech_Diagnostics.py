...
rootdirectory=r'/Users/compastro/greene/AGN_SED'
...
for root, dirs, files in os.walk(rootdirectory, topdown=False):
    for name in files:
        if name.startswith('Ionization_35_Linear_Fit_ax219_SED') and name.endswith('.lin'):
            #print name
        ...
        elif name.startswith('Ionization_35_Linear_Fit_ax117_SED') and name.endswith('.lin'):
            #print name
            #only read columns from list cols
            ...
            'NE 3  3869A','AR 3  7135A','HE 1  5876A','TOTL  4363A','O  3  4959A','O II  3726A', 'O II  3729A']))
            d = pd.concat(dfs, ignore_index=True)
        elif name.startswith('Aox124_Metallicity15_Ionization_35') and name.endswith('.lin'):
             #print name
            #only read columns from list cols
             dfs.append(pd.read_csv(os.path.join(root, name), delimiter="\t", sep='\s*',usecols=['TOTL  4861A','O  3  5007A', 'NE 5  3426A', 'NE 3  3869A',
            'TOTL  4363A', 'O  1  6300A', 'H  1  6563A','N  2  6584A','S  2  6720A' , 'HE 2  4686A','TOTL  3727A', 'S II  6716A', 'S II  6731A',
...
SDSS_Ratios_File = r'/Users/compastro/greene/AGN_SED/sdss_data/flux_norm_AGN.csv'
...
ax1 = plt.subplot(231, adjustable = 'box-forced')
...
ax1.scatter(np.log10(SDSS_Data_Ratios[(Linercondition1 & Linercondition2),7]),np.log10(SDSS_Data_Ratios[(Linercondition1 & Linercondition2),8]),edgecolor = '', s = 5, c = 'g')
...
l1 = ax1.scatter(d['N II / H-Alpha'].get_value(0),d['O III / H-Beta'].get_value(0), marker = "s", c = '#FF5D5D', s = 50, label = "10^4 ax=2.19")
l2 = ax1.scatter(d['N II / H-Alpha'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s", c = '#FF0000', s = 50, label = "10^5 ax=2.19")
l3 = ax1.scatter(d['N II / H-Alpha'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s", c = '#C60000',s = 50, label = "10^6 ax=2.19")
l4 = ax1.scatter(d['N II / H-Alpha'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s", c = '#9B0000', s = 50, label = "10^7 ax=2.19")
l5 = ax1.scatter(d['N II / H-Alpha'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4 ax=1.17")
l6 = ax1.scatter(d['N II / H-Alpha'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5 ax=1.17")
l7 = ax1.scatter(d['N II / H-Alpha'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6 ax=1.17")
l8 = ax1.scatter(d['N II / H-Alpha'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7 ax=1.17")
l9 = ax1.scatter(d['N II / H-Alpha'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
l10 = ax1.scatter(d['N II / H-Alpha'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
l11 = ax1.scatter(d['N II / H-Alpha'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
l12 = ax1.scatter(d['N II / H-Alpha'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
ax1.set_ylabel(r'Log$_{10}$([O III] $\lambda 5007$ / H$\beta$)', fontsize = 18)
ax1.set_xlabel(r'Log$_{10}$([N II] $\lambda 6584$ / H$\alpha$)', fontsize = 18)
ax1.text(-1,1,'AGN')
...
ax2.scatter(np.log10(SDSS_Data_Ratios[(Linercondition3 & Linercondition5),5]),np.log10(SDSS_Data_Ratios[(Linercondition3 & Linercondition5),8]),edgecolor = '', s = 5, c = 'g')
...
ax2.scatter(d['O I / H-Alpha'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
ax2.scatter(d['O I / H-Alpha'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
ax2.scatter(d['O I / H-Alpha'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
ax2.scatter(d['O I / H-Alpha'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
ax2.scatter(d['O I / H-Alpha'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
ax2.scatter(d['O I / H-Alpha'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
ax2.scatter(d['O I / H-Alpha'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
ax2.scatter(d['O I / H-Alpha'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
ax2.scatter(d['O I / H-Alpha'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
ax2.set_ylabel(r'Log$_{10}$([O III] $\lambda 5007$ / H$\beta$)', fontsize = 18)
ax2.set_xlabel(r'Log$_{10}$([O I] $\lambda 6300$ / H$\alpha$)', fontsize = 18)
...
ax3.scatter(np.log10(SDSS_Data_Ratios[(Linercondition6 & Linercondition4),18]),np.log10(SDSS_Data_Ratios[(Linercondition6 & Linercondition4),8]), edgecolor = '', c = 'g',s=5.0)
...
ax3.scatter(d['S II / H-Alpha'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")

ax3.scatter(d['S II / H-Alpha'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
ax3.scatter(d['S II / H-Alpha'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
ax3.scatter(d['S II / H-Alpha'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
ax3.scatter(d['S II / H-Alpha'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
ax3.scatter(d['S II / H-Alpha'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
ax3.scatter(d['S II / H-Alpha'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
ax3.scatter(d['S II / H-Alpha'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
ax3.scatter(d['S II / H-Alpha'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
ax3.set_ylabel(r'Log$1{10}$([O III] $\lambda 5007$ / H$\beta$)', fontsize = 18)
ax3.set_xlabel(r'Log$_{10}$([S II] $\lambda 6720$ / H$\alpha$)', fontsize = 18)
...
ax4.scatter(d['O II / H-Beta'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
ax4.scatter(d['O II / H-Beta'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
ax4.scatter(d['O II / H-Beta'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
ax4.scatter(d['O II / H-Beta'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
ax4.scatter(d['O II / H-Beta'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
ax4.set_ylabel(r'Log$_{10}$([O III] $\lambda 5007$ / H$\beta$)', fontsize = 18)
ax4.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / H$\beta$)', fontsize = 18)
...
ax6.scatter(d['O I / H-Alpha'].get_value(9),d['O III / O II'].get_value(9), marker = "s",c='#9B0000', s = 50, label = "10^7")
ax6.scatter(d['O I / H-Alpha'].get_value(1),d['O III / O II'].get_value(1), marker = "s",c='#7056C5', s = 50, label = "10^4")
ax6.scatter(d['O I / H-Alpha'].get_value(4),d['O III / O II'].get_value(4), marker = "s",c='#3914AF', s = 50, label = "10^5")
ax6.scatter(d['O I / H-Alpha'].get_value(7),d['O III / O II'].get_value(7), marker = "s",c='#2B0E87', s = 50, label = "10^6")
ax6.scatter(d['O I / H-Alpha'].get_value(10),d['O III / O II'].get_value(10), marker = "s",c='#200969', s = 50, label = "10^7")
ax6.scatter(d['O I / H-Alpha'].get_value(2),d['O III / O II'].get_value(2), marker = "s",c='#50DA50', s = 50, label = "10^4")
ax6.scatter(d['O I / H-Alpha'].get_value(5),d['O III / O II'].get_value(5), marker = "s",c='#00CC00', s = 50, label = "10^5")
ax6.scatter(d['O I / H-Alpha'].get_value(8),d['O III / O II'].get_value(8), marker = "s",c='#009D00', s = 50, label = "10^6")
ax6.scatter(d['O I / H-Alpha'].get_value(11),d['O III / O II'].get_value(11), marker = "s",c='#007A00', s = 50, label = "10^7")
...
ax6.set_xlabel(r'Log$_{10}$([O I] $\lambda 6300$ / H$\alpha$)', fontsize = 18)
ax6.set_ylabel(r'Log$_{10}$([O III] $\lambda 5007$) / [O II] $\lambda 3727$)', fontsize = 18)
ax6.text(-1.5,1,'Seyfert')
ax6.text(-0.1,0,'LINER')    
ax6.text(-2.2,-1.3, 'Star-Forming')
plt.suptitle('AGN Excitation Mechanism Diagnostic Plots:Aox = 1.24, Metallicity = 1.5, Efrac = 0.01, Phi(h) = 10.4771, n(h) = 2.5',fontsize = 20)
...
plt.show() 
plt.savefig('/Users/compastro/greene/AGN_SED/Presentations/Optical_excitation_Aox124.png', dpi=1000)
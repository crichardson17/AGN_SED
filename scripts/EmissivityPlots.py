...
ax5.plot(NitrogenT4_data[:,0],np.divide(10**NitrogenT4_data[:,3],10**np.amax(NitrogenT4_data[:,3])), c = 'g',ls = '--', label = 'O I 6200')
...
ax7.plot(nitrogenT6_data[:,0],10**nitrogenT6_data[:,1]/10**np.amax(nitrogenT6_data[:,1]), c = 'b',ls = '--')
ax7.plot(nitrogenT6_data[:,0],10**nitrogenT6_data[:,4]/10**np.amax(nitrogenT6_data[:,4]), c = 'r')
ax7.plot(nitrogenT6_data[:,0],10**nitrogenT6_data[:,9]/10**np.amax(nitrogenT6_data[:,9]), c = 'r',ls = '-.')
ax7.plot(nitrogenT6_data[:,0],10**nitrogenT6_data[:,2]/10**np.amax(nitrogenT6_data[:,2]), c = 'r',ls = '--')
ax7.plot(nitrogenT6_data[:,0],10**nitrogenT6_data[:,3]/10**np.amax(nitrogenT6_data[:,3]), c = 'g',ls = '--')
ax7.plot(nitrogenT6_data[:,0],10**nitrogenT6_data[:,8]/10**np.amax(nitrogenT6_data[:,8]),c = 'g', label = 'N I 5200')

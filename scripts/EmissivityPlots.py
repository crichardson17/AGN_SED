...
ax1.plot(NitrogenT4_data[:,0],NitrogenT4_data[:,4], c = 'r', ls = '--', label = 'N2 6584')
ax1.plot(NitrogenT4_data[:,0],NitrogenT4_data[:,9], c = 'r', ls = '-.', label = 'S II 6720')
ax1.plot(NitrogenT4_data[:,0],NitrogenT4_data[:,2], c = 'r',label = 'O II 3727')
ax1.plot(NitrogenT4_data[:,0],NitrogenT4_data[:,3], c = 'black', label = 'O I 6200')
ax1.plot(NitrogenT4_data[:,0], NitrogenT4_data[:,8],c = 'black',ls = '--', label = 'N I 5200')
ax1.set_ylabel(r'$\alpha$x = 1.42')
ax1.set_title(r'$T_{bb}=10^4$')

ax2.plot(NitrogenT5_data[:,0],NitrogenT5_data[:,1], c = 'g')
ax2.plot(NitrogenT5_data[:,0],NitrogenT5_data[:,4], c = 'r',ls = '--')
ax2.plot(NitrogenT5_data[:,0],NitrogenT5_data[:,9], c = 'r',ls = '-.')
ax2.plot(NitrogenT5_data[:,0],NitrogenT5_data[:,2], c = 'r')
ax2.plot(NitrogenT5_data[:,0],NitrogenT5_data[:,3], c = 'black')
ax2.plot(NitrogenT5_data[:,0], NitrogenT5_data[:,8],c = 'black',ls = '--', label = 'N I 5200')
ax2.set_title(r'$T_{bb}=10^5$')

ax3.plot(nitrogenT6_data[:,0],nitrogenT6_data[:,1], c = 'g')
ax3.plot(nitrogenT6_data[:,0],nitrogenT6_data[:,4], c = 'r',ls = '--')
ax3.plot(nitrogenT6_data[:,0],nitrogenT6_data[:,9], c = 'r',ls = '-.')
ax3.plot(nitrogenT6_data[:,0],nitrogenT6_data[:,2], c = 'r')
ax3.plot(nitrogenT6_data[:,0],nitrogenT6_data[:,3], c = 'black')
ax3.plot(nitrogenT6_data[:,0], nitrogenT6_data[:,8],c = 'black',ls = '--', label = 'N I 5200')
ax3.set_title(r'$T_{bb}=10^6$')

ax4.plot(nitrogenT7_data[:,0],nitrogenT7_data[:,1], c = 'g')
ax4.plot(nitrogenT7_data[:,0],nitrogenT7_data[:,4], c = 'r',ls = '--')
ax4.plot(nitrogenT7_data[:,0],nitrogenT7_data[:,9], c = 'r',ls = '-.')
ax4.plot(nitrogenT7_data[:,0],nitrogenT7_data[:,2], c = 'r')
ax4.plot(nitrogenT7_data[:,0],nitrogenT7_data[:,3], c = 'black')
ax4.plot(nitrogenT7_data[:,0], nitrogenT7_data[:,8],c = 'black',ls = '--', label = 'N I 5200')
...
ax5.plot(nitrogenT4_ax117_data[:,0],nitrogenT4_ax117_data[:,4], c = 'r',ls = '--')
ax5.plot(nitrogenT4_ax117_data[:,0],nitrogenT4_ax117_data[:,9], c = 'r',ls = '-.')
...
ax5.plot(nitrogenT4_ax117_data[:,0],nitrogenT4_ax117_data[:,8], c = 'black', ls = '--')
ax5.set_ylabel(r'$\alpha$x = 1.17')

ax6.plot(nitrogenT5_ax117_data[:,0],nitrogenT5_ax117_data[:,1], c = 'g')
ax6.plot(nitrogenT5_ax117_data[:,0],nitrogenT5_ax117_data[:,4], c = 'r',ls = '--')
ax6.plot(nitrogenT5_ax117_data[:,0],nitrogenT5_ax117_data[:,9], c = 'r', ls = '-.')
...
ax6.plot(nitrogenT5_ax117_data[:,0],nitrogenT5_ax117_data[:,8], c = 'black', ls = '--')

ax7.plot(nitrogenT6_ax117_data[:,0],nitrogenT6_ax117_data[:,1], c = 'g')
ax7.plot(nitrogenT6_ax117_data[:,0],nitrogenT6_ax117_data[:,4], c = 'r',ls = '--')
ax7.plot(nitrogenT6_ax117_data[:,0],nitrogenT6_ax117_data[:,9], c = 'r', ls = '-.')
...
ax7.plot(nitrogenT6_ax117_data[:,0],nitrogenT6_ax117_data[:,8], c = 'black', ls = '--')

ax8.plot(nitrogenT7_ax117_data[:,0],nitrogenT7_ax117_data[:,1], c = 'g')
ax8.plot(nitrogenT7_ax117_data[:,0],nitrogenT7_ax117_data[:,4], c = 'r',ls = '--')
ax8.plot(nitrogenT7_ax117_data[:,0],nitrogenT7_ax117_data[:,9], c = 'r', ls = '-.')
...
ax8.plot(nitrogenT7_ax117_data[:,0],nitrogenT7_ax117_data[:,8], c = 'black', ls = '--')
#Plot ax = 219 structure for each temperature 
ax9.plot(nitrogenT4_ax219_data[:,0],nitrogenT4_ax219_data[:,1], c = 'g')
ax9.plot(nitrogenT4_ax219_data[:,0],nitrogenT4_ax219_data[:,4], c = 'r',ls = '--')
ax9.plot(nitrogenT4_ax219_data[:,0],nitrogenT4_ax219_data[:,9], c = 'r',ls = '-.')
...
ax9.plot(nitrogenT4_ax219_data[:,0],nitrogenT4_ax219_data[:,8], c = 'black',ls = '--')

ax9.set_ylabel(r'$\alpha$x = 2.19')
#ax9.set_xlabel(r'$T_{bb} = 10^4$')

ax10.plot(nitrogenT5_ax219_data[:,0],nitrogenT5_ax219_data[:,1], c = 'g')
ax10.plot(nitrogenT5_ax219_data[:,0],nitrogenT5_ax219_data[:,4], c = 'r',ls = '--')
ax10.plot(nitrogenT5_ax219_data[:,0],nitrogenT5_ax219_data[:,9], c = 'r',ls = '-.')
...
ax10.plot(nitrogenT5_ax219_data[:,0],nitrogenT5_ax219_data[:,8], c = 'black',ls = '--')
#ax10.set_xlabel(r'$T_{bb} = 10^5$')

ax11.plot(nitrogenT6_ax219_data[:,0],nitrogenT6_ax219_data[:,1], c = 'g')
ax11.plot(nitrogenT6_ax219_data[:,0],nitrogenT6_ax219_data[:,4], c = 'r',ls = '--')
ax11.plot(nitrogenT6_ax219_data[:,0],nitrogenT6_ax219_data[:,9], c = 'r', ls = '-.')
...
ax11.plot(nitrogenT6_ax219_data[:,0],nitrogenT6_ax219_data[:,8], c = 'black',ls = '--')

#ax11.set_xlabel(r'$T_{bb} = 10^6$')

ax12.plot(nitrogenT7_ax219_data[:,0],nitrogenT7_ax219_data[:,1], c = 'g')
ax12.plot(nitrogenT7_ax219_data[:,0],nitrogenT7_ax219_data[:,4], c = 'r', ls = '--')
ax12.plot(nitrogenT7_ax219_data[:,0],nitrogenT7_ax219_data[:,9], c = 'r', ls = '-.')
...
ax12.plot(nitrogenT7_ax219_data[:,0],nitrogenT7_ax219_data[:,8], c = 'black', ls = '--')

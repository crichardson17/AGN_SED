...
ax1 = plt.subplot(131, aspect = 'equal', adjustable = 'box-forced')
ax2 = plt.subplot(132, aspect = 'equal', adjustable = 'box-forced')
ax3 = plt.subplot(133, aspect = 'equal', adjustable = 'box-forced')
...
ax1.scatter(np.log10(SF_Array[:,1]),np.log10(SF_Array[:,8]) , c = '#453785',edgecolor = '', s = 5)
ax1.scatter(np.log10(AGN_Array[:,1]),np.log10(AGN_Array[:,8]), edgecolor = '', c = '#800000', s = 5)
ax1.scatter(np.log10(Comp_Array[:,1]),np.log10(Comp_Array[:,8]),edgecolor = '', s = 5)
ax1.scatter(np.log10(SDSS_Data_Ratios[Linercondition3 & Linercondition5,1]),np.log10(SDSS_Data_Ratios[Linercondition3 & Linercondition5,8]),edgecolor = '', s = 5, c = 'g')
...
ax1.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [O III] $\lambda 5007$)',fontsize = 20)
...
ax2.scatter(np.log10(SF_Array[:,1]),np.log10(SF_Array[:,6]) , c = '#453785',edgecolor = '', s = 5)
ax2.scatter(np.log10(AGN_Array[:,1]),np.log10(AGN_Array[:,6]),edgecolor = '', s = 5, c = '#800000')
ax2.scatter(np.log10(Comp_Array[:,1]),np.log10(Comp_Array[:,6]),edgecolor = '', s = 5)
ax2.scatter(np.log10(SDSS_Data_Ratios[Linercondition3 & Linercondition5,1]),np.log10(SDSS_Data_Ratios[Linercondition3 & Linercondition5,6]),edgecolor = '', s = 5, c = 'g')
...
ax2.set_ylabel(r'Log$_{10}$([O I] $\lambda 6300$ / [O III] $\lambda 5007$)',fontsize = 20)
ax2.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [O III] $\lambda 5007$)',fontsize = 20)
ax2.set_xlim(-2,2)
...
ax3.scatter(np.log10(SF_Array[:,4]),np.log10(SF_Array[:,8]) , c = '#453785',edgecolor = '', s = 5)
ax3.scatter(np.log10(AGN_Array[:,4]), np.log10(AGN_Array[:,8]),edgecolor = '', c = '#800000',s=5)
ax3.scatter(np.log10(Comp_Array[:,4]),np.log10(Comp_Array[:,8]),edgecolor = '', s = 5)
ax3.scatter(np.log10(SDSS_Data_Ratios[Linercondition3 & Linercondition5,4]),np.log10(SDSS_Data_Ratios[Linercondition3 & Linercondition5,8]),edgecolor = '', s = 5, c = 'g')
...
ax3.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [O I] $\lambda 6300$)',fontsize = 20)
...
ax3.legend(loc = 'best')
plt.suptitle('AGN SED Diagnostic Plots: Metallicity = 1.5, Efrac = 0.01, Phi(h) = 10.4771, n(h) = 2.5',fontsize = 20)
plt.show() 
plt.savefig('C:\Users\chris_000\Documents\GitHub\AGN_SED\Presentations\SED_Diagnostics.png',dpi = 1000)
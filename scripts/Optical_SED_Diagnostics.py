...
ax4.set_ylabel(r'Log$_{10}$([He II] $\lambda 4686$ / [He I] $\lambda 5876$)')
...
ax5.scatter(np.log10(np.divide(SDSS_Data_HeII[:,22],SDSS_Data_HeII[:,28])),np.log10(np.divide(SDSS_Data_HeII[:,15],SDSS_Data_HeII[:,23])),edgecolor = '', c = '#000080',s=5)
ax5.scatter(np.log10(np.divide(AGN_Array2[:,22],AGN_Array2[:,28])), np.log10(np.divide(AGN_Array2[:,15],AGN_Array2[:,23])),edgecolor = '', c = '#800000',s=5)
ax5.scatter(d['N I 5200 / N II 6584'].get_value(0),d['He II / He I'].get_value(0), marker = "s",c='#FF5D5D', s = 30, label = "10^4")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(3),d['He II / He I'].get_value(3), marker = "s",c='#FF0000', s = 30, label = "10^5")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(6),d['He II / He I'].get_value(6), marker = "s",c='#C60000', s = 30, label = "10^6")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(9),d['He II / He I'].get_value(9), marker = "s",c='#9B0000', s = 30, label = "10^7")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(1),d['He II / He I'].get_value(1), marker = "s",c='#7056C5', s = 30, label = "10^4")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(4),d['He II / He I'].get_value(4), marker = "s",c='#3914AF', s = 30, label = "10^5")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(7),d['He II / He I'].get_value(7), marker = "s",c='#2B0E87', s = 30, label = "10^6")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(10),d['He II / He I'].get_value(10), marker = "s",c='#200969', s = 30, label = "10^7")
ax5.set_ylabel(r'Log$_{10}$([He II] $\lambda 4686$ / [He I] $\lambda 5876$)')
ax5.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [O III] $\lambda 5007$)')
ax5.scatter(d['N I 5200 / N II 6584'].get_value(2),d['He II / He I'].get_value(2), marker = "s", c='#50DA50', s = 30, label = "10^4")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(5),d['He II / He I'].get_value(5), marker = "s",c='#00CC00', s = 30, label = "10^5")
ax5.scatter(d['N I 5200 / N II 6584'].get_value(8),d['He II / He I'].get_value(8), marker = "s",c='#009D00', s = 30, label = "10^6")
ax5 .scatter(d['N I 5200 / N II 6584'].get_value(11),d['He II / He I'].get_value(11), marker = "s",c='#007A00', s = 30, label = "10^7")

...
ax2.scatter(d['O IV / S IV'].get_value(0),d['Ne V / S IV'].get_value(0) , marker = "s",c='#FF5D5D', s = 30, label = "10^4")
ax2.scatter(d['O IV / S IV'].get_value(3),d['Ne V / S IV'].get_value(3) , marker = "s",c='#FF0000', s = 30, label = "10^5")
ax2.scatter(d['O IV / S IV'].get_value(6),d['Ne V / S IV'].get_value(6) , marker = "s",c='#C60000', s = 30, label = "10^6")
ax2.scatter(d['O IV / S IV'].get_value(9),d['Ne V / S IV'].get_value(9) , marker = "s",c='#9B0000', s = 30, label = "10^7")
ax2.scatter(d['O IV / S IV'].get_value(1),d['Ne V / S IV'].get_value(1) , marker = "s",c='#7056C5', s = 30, label = "10^4 Fit")
ax2.scatter(d['O IV / S IV'].get_value(4),d['Ne V / S IV'].get_value(4) , marker = "s",c='#3914AF', s = 30, label = "10^5 Fit")
ax2.scatter(d['O IV / S IV'].get_value(7),d['Ne V / S IV'].get_value(7) , marker = "s",c='#2B0E87', s = 30, label = "10^6 Fit")
ax2.scatter(d['O IV / S IV'].get_value(10),d['Ne V / S IV'].get_value(10) , marker = "s",c='#200969', s = 30, label = "10^7 Fit")
ax2.scatter(d['O IV / S IV'].get_value(2),d['Ne V / S IV'].get_value(2) , marker = "s",c='#50DA50', s = 30, label = "10^4 Fit")
ax2.scatter(d['O IV / S IV'].get_value(5),d['Ne V / S IV'].get_value(5) , marker = "s",c='#00CC00', s = 30, label = "10^5 Fit")
ax2.scatter(d['O IV / S IV'].get_value(8),d['Ne V / S IV'].get_value(8) , marker = "s",c='#009D00', s = 30, label = "10^6 Fit")
ax2.scatter(d['O IV / S IV'].get_value(11),d['Ne V / S IV'].get_value(11) , marker = "s",c='#007A00', s = 30, label = "10^7 Fit")
ax2.plot(baseO4S4,baseNe5S4, c= '0')
ax2.plot(linO4S4,linNe5S4, c = '0')
ax2.plot(lin21O4S4,lin21Ne5S4, c = '0')
...
ax3.scatter(d['S IV / Ne II'].get_value(0),d['O IV / Ne II'].get_value(0) , marker = "s",c='#FF5D5D', s = 30, label = "10^4")
ax3.scatter(d['S IV / Ne II'].get_value(3),d['O IV / Ne II'].get_value(3) , marker = "s",c='#FF0000', s = 30, label = "10^5")
ax3.scatter(d['S IV / Ne II'].get_value(6),d['O IV / Ne II'].get_value(6) , marker = "s",c='#C60000', s = 30, label = "10^6")
ax3.scatter(d['S IV / Ne II'].get_value(9),d['O IV / Ne II'].get_value(9) , marker = "s",c='#9B0000', s = 30, label = "10^7")
ax3.scatter(d['S IV / Ne II'].get_value(1),d['O IV / Ne II'].get_value(1) , marker = "s",c='#7056C5', s = 30, label = "10^4 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(4),d['O IV / Ne II'].get_value(4) , marker = "s",c='#3914AF', s = 30, label = "10^5 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(7),d['O IV / Ne II'].get_value(7) , marker = "s",c='#2B0E87', s = 30, label = "10^6 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(10),d['O IV / Ne II'].get_value(10) , marker = "s",c='#200969', s = 30, label = "10^7 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(2),d['O IV / Ne II'].get_value(2) , marker = "s",c='#50DA50', s = 30, label = "10^4 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(5),d['O IV / Ne II'].get_value(5) , marker = "s",c='#00CC00', s = 30, label = "10^5 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(8),d['O IV / Ne II'].get_value(8) , marker = "s",c='#009D00', s = 30, label = "10^6 Fit")
ax3.scatter(d['S IV / Ne II'].get_value(11),d['O IV / Ne II'].get_value(11) , marker = "s",c='#007A00', s = 30, label = "10^7 Fit")
ax3.plot(baseS4Ne2, baseO4Ne2, c= '0')
ax3.plot(linS4Ne2, linO4Ne2, c= '0')
ax3.plot(lin21S4Ne2, lin21O4Ne2, c= '0')

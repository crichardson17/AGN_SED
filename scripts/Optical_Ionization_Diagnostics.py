...
ax1.scatter(np.log10(SDSS_Data_Ratios[:,8]),np.log10(SDSS_Data_Ratios[:,2]),edgecolor = '', c = '#000080',s=5)
ax1.scatter(np.log10(AGN_Array[:,8]),np.log10(AGN_Array[:,2]),edgecolor = '', c = '#800000',s=5)
ax1.scatter(d['O II / O III'].get_value(0),d['O I / H-Alpha'].get_value(0), marker = "s",c='green', s = 30, label = "10^4")
ax1.scatter(d['O II / O III'].get_value(1),d['O I / H-Alpha'].get_value(1), marker = "s",c='cyan', s = 30, label = "10^5")
ax1.scatter(d['O II / O III'].get_value(2),d['O I / H-Alpha'].get_value(2), marker = "s",c='r', s = 30, label = "10^6")
ax1.scatter(d['O II / O III'].get_value(3),d['O I / H-Alpha'].get_value(3), marker = "s",c='magenta', s = 30, label = "10^7")
ax1.set_ylabel(r'Log$_{10}$([O I] $\lambda 6300$ / H$\alpha$)')
ax1.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / [O III] $\lambda 5007$)')
ax1.set_xlim(np.log10(10**(-1.5)),np.log10(10**2))
ax1.set_ylim(np.log10(10**(-2.5)), np.log10(10**(0)))

ax2.scatter(np.log10(SDSS_Data_Ratios[:,1]),np.log10(SDSS_Data_Ratios[:,2]),edgecolor = '', c = '#000080',s=5)
ax2.scatter(np.log10(AGN_Array[:,1]), np.log10(AGN_Array[:,2]),edgecolor = '', c = '#800000',s=5)
ax2.scatter(d['O II / H-Beta'].get_value(0),d['O I / H-Alpha'].get_value(0), marker = "s",c='green', s = 30, label = "10^4")
ax2.scatter(d['O II / H-Beta'].get_value(1),d['O I / H-Alpha'].get_value(1), marker = "s",c='cyan', s = 30, label = "10^5")
ax2.scatter(d['O II / H-Beta'].get_value(2),d['O I / H-Alpha'].get_value(2), marker = "s",c='r', s = 30, label = "10^6")
ax2.scatter(d['O II / H-Beta'].get_value(3),d['O I / H-Alpha'].get_value(3), marker = "s",c='magenta', s = 30, label = "10^7")
ax2.set_ylabel(r'Log$_{10}$([O I] $\lambda 6300$ / H$\alpha$)')
ax2.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / H$\beta$)')
ax2.set_xlim(np.log10(10**(-1.5)),np.log10(10**2))
ax2.set_ylim(np.log10(10**(-2.5)), np.log10(10**(0)))

ax3.scatter(np.log10(SDSS_Data_Ratios[:,1]),np.log10(SDSS_Data_Ratios[:,8]),edgecolor = '', c = '#000080',s=5)
ax3.scatter(np.log10(AGN_Array[:,1]), np.log10(AGN_Array[:,8]),edgecolor = '', c = '#800000',s=5)
ax3.scatter(d['O II / H-Beta'].get_value(0),d['O II / O III'].get_value(0), marker = "s",c='green', s = 30, label = "10^4")
ax3.scatter(d['O II / H-Beta'].get_value(1),d['O II / O III'].get_value(1), marker = "s",c='cyan', s = 30, label = "10^5")
ax3.scatter(d['O II / H-Beta'].get_value(2),d['O II / O III'].get_value(2), marker = "s",c='r', s = 30, label = "10^6")
ax3.scatter(d['O II / H-Beta'].get_value(3),d['O II / O III'].get_value(3), marker = "s",c='magenta', s = 30, label = "10^7")
ax3.set_ylabel(r'Log$_{10}$([O II] $\lambda 3727$ / [O III] $\lambda 5007$)')
ax3.set_xlabel(r'Log$_{10}$([O II] $\lambda 3727$ / H$\beta$)')

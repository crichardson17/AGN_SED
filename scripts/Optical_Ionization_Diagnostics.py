...
ax1.scatter(d['O II / O III'].get_value(3),d['O III 4363 / H-Alpha'].get_value(3), marker = "s",c='g', s = 30, label = "10^5")
ax1.scatter(d['O II / O III'].get_value(6),d['O III 4363 / H-Alpha'].get_value(6), marker = "s",c='y', s = 30, label = "10^6")
ax1.scatter(d['O II / O III'].get_value(9),d['O III 4363 / H-Alpha'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax1.scatter(d['O II / O III'].get_value(1),d['O III 4363 / H-Alpha'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4 ax=1.17")
ax1.scatter(d['O II / O III'].get_value(4),d['O III 4363 / H-Alpha'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5 ax=1.17")
ax1.scatter(d['O II / O III'].get_value(7),d['O III 4363 / H-Alpha'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6 ax=1.17")
ax1.scatter(d['O II / O III'].get_value(10),d['O III 4363 / H-Alpha'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7 ax=1.17")
ax1.scatter(d['O II / O III'].get_value(2),d['O III 4363 / H-Alpha'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4 ax=2.19")
ax1.scatter(d['O II / O III'].get_value(5),d['O III 4363 / H-Alpha'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5 ax=2.19")
ax1.scatter(d['O II / O III'].get_value(8),d['O III 4363 / H-Alpha'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6 ax=2.19")
ax1.scatter(d['O II / O III'].get_value(11),d['O III 4363 / H-Alpha'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7 ax=2.19")
...
ax2.scatter(d['O II / O III'].get_value(3),d['O III / H-Beta'].get_value(3), marker = "s",c='green', s = 30, label = "10^5")
ax2.scatter(d['O II / O III'].get_value(6),d['O III / H-Beta'].get_value(6), marker = "s",c='y', s = 30, label = "10^6")
ax2.scatter(d['O II / O III'].get_value(9),d['O III / H-Beta'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax2.scatter(d['O II / O III'].get_value(1),d['O III / H-Beta'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax2.scatter(d['O II / O III'].get_value(4),d['O III / H-Beta'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax2.scatter(d['O II / O III'].get_value(7),d['O III / H-Beta'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax2.scatter(d['O II / O III'].get_value(10),d['O III / H-Beta'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax2.scatter(d['O II / O III'].get_value(2),d['O III / H-Beta'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax2.scatter(d['O II / O III'].get_value(5),d['O III / H-Beta'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax2.scatter(d['O II / O III'].get_value(8),d['O III / H-Beta'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax2.scatter(d['O II / O III'].get_value(11),d['O III / H-Beta'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
...
ax3.scatter(d['O II / O III'].get_value(3),d['O II / H-Beta'].get_value(3), marker = "s",c='g', s = 30, label = "10^5")
ax3.scatter(d['O II / O III'].get_value(6),d['O II / H-Beta'].get_value(6), marker = "s",c='y', s = 30, label = "10^6")
ax3.scatter(d['O II / O III'].get_value(9),d['O II / H-Beta'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax3.scatter(d['O II / O III'].get_value(1),d['O II / H-Beta'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax3.scatter(d['O II / O III'].get_value(4),d['O II / H-Beta'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax3.scatter(d['O II / O III'].get_value(7),d['O II / H-Beta'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax3.scatter(d['O II / O III'].get_value(10),d['O II / H-Beta'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax3.scatter(d['O II / O III'].get_value(2),d['O II / H-Beta'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax3.scatter(d['O II / O III'].get_value(5),d['O II / H-Beta'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax3.scatter(d['O II / O III'].get_value(8),d['O II / H-Beta'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax3.scatter(d['O II / O III'].get_value(11),d['O II / H-Beta'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
...
ax4.scatter(d['O II / H-Beta'].get_value(3),d['O I / H-Alpha'].get_value(3), marker = "s",c='g', s = 30, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(6),d['O I / H-Alpha'].get_value(6), marker = "s",c='y', s = 30, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(9),d['O I / H-Alpha'].get_value(9), marker = "s",c='magenta', s = 30, label = "10^7")
ax4.scatter(d['O II / H-Beta'].get_value(1),d['O I / H-Alpha'].get_value(1), marker = "s",c='#F06E07', s = 30, label = "10^4")
ax4.scatter(d['O II / H-Beta'].get_value(4),d['O I / H-Alpha'].get_value(4), marker = "s",c='#111DD9', s = 30, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(7),d['O I / H-Alpha'].get_value(7), marker = "s",c='#ABF036', s = 30, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(10),d['O I / H-Alpha'].get_value(10), marker = "s",c='#D91C82', s = 30, label = "10^7")
ax4.scatter(d['O II / H-Beta'].get_value(2),d['O I / H-Alpha'].get_value(2), marker = "s",c='#2C3E50', s = 30, label = "10^4")
ax4.scatter(d['O II / H-Beta'].get_value(5),d['O I / H-Alpha'].get_value(5), marker = "s",c='#E74C3C', s = 30, label = "10^5")
ax4.scatter(d['O II / H-Beta'].get_value(8),d['O I / H-Alpha'].get_value(8), marker = "s",c='#ECF0F1', s = 30, label = "10^6")
ax4.scatter(d['O II / H-Beta'].get_value(11),d['O I / H-Alpha'].get_value(11), marker = "s",c='#3498DB', s = 30, label = "10^7")
